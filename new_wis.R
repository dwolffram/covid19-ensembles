...
row_index <- names(df_train)[!(names(df_train) %in% c("quantile", "value"))]
df_wide <- reshape(df_train, direction = "wide", timevar = "quantile",
...
#ncol(df_wide[, grepl("wgt_iw", colnames(df_wide))]) - 0.5
